...
-Song : to store title and artist,
...
This view displays at left an alphabetical ordered list of the N song stored in database.
At the right, this view displays the randomly generated playlist correspondig to the current day if it has been generated, otherwise th view displays a "SHUFFLE IT" button to generate and store the daily random playlist.
The random list of the N song is generated in the "playlist_controller".
